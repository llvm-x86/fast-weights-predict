...
% --- RUBRIC A1 (REQUIRED): arXiv rejects anonymous submissions. Replace with the
%     real author name(s), affiliation, and contact email before submitting. ---
\author{Author Name Here\\Affiliation\\\texttt{email@example.com}}
...
\url{https://github.com/<USER>/<REPO>} --- \emph{replace with the actual public URL before
submission}; arXiv requires that code/data links resolve to a public repository.
